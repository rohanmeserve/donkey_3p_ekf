...
IMU_SENSOR = 'oakd_BNO086'          # (mpu6050|mpu9250)
...
AI_LAUNCH_ENABLE_BUTTON = 'web/w1'      # this keypress will enable this boost. It must be enabled before each use to prevent accidental trigger.
...
PATH_MIN_DIST = 0.35                 # after travelling this distance (m), save a path point
PATH_SEARCH_LENGTH = 6           # number of points to search for closest point, None to search entire path
PATH_LOOK_AHEAD = 3                 # number of points ahead of the closest point to include in cte track
...
PID_THROTTLE = 1.0                 # constant throttle value during path following
...
# #
#SAVE_PATH_BTN = "B"        # button to save path
#LOAD_PATH_BTN = "X"             # button (re)load path
#RESET_ORIGIN_BTN = "L1"     # button to press to move car back to origin
#ERASE_PATH_BTN = "Y"     # button to erase path
#TOGGLE_RECORDING_BTN = "R1" # button to toggle recording mode
SAVE_PATH_BTN = "web/w3"        # button to save path
LOAD_PATH_BTN = "web/w5"             # button (re)load path
RESET_ORIGIN_BTN = "web/w4"     # button to press to move car back to origin
ERASE_PATH_BTN = "web/w1"     # button to erase path
TOGGLE_RECORDING_BTN = "web/w2" # button to toggle recording mode
